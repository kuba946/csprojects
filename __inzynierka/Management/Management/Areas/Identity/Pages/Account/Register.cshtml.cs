...
namespace Management.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "inputFirstName")]
            public string inputFirstName { get; set; }

            [Required]
            [StringLength(100, ErrorMessage = "Cannot be empty.", MinimumLength = 2)]
            [DataType(DataType.Text)]
            [Display(Name = "inputLastName")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.FirstName = Input.inputFirstName;
                user.LastName = Input.inputLastName;
                user.Role = _applicationDbContext.Roles.Where(r => r.Name == "User").SingleOrDefault();
                ...
                if (result.Succeeded)
                {
                    ...
                    var userRole = from ur in _applicationDbContext.Roles
                                   where ur.Name == "User"
                                   select ur;
