...
public class AdminIssueController : Controller
{
    ...
    public AdminIssueController(ILogger<HomeController> logger, ApplicationDbContext context)
    {
        _logger = logger;
        _context = context;
    }
    ...
    public async Task<IActionResult> Delete(int? id)
    {
        ...
        return RedirectToAction("Index", "AdminIssue");
    }

    // POST: AdminIssue/Delete/5
    ...
    public async Task<IActionResult> Create([Bind("IssueNameDto", "IssueParentIdDto", "IssueStatusNameDto", "IssueStartDateDto", "IssueEndDateDto", "IssueAssigneeNameDto", "IssueDescriptionDto")] IndexModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            issue = new Issue(model.IssueNameDto, startDate, endDate, null, model.IssueDescriptionDto, status, parent, assignee);
