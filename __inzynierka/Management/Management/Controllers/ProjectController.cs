...
public class ProjectController : Controller
{
    ...
    public ProjectController(ILogger<HomeController> logger, ApplicationDbContext context)
    {
        _logger = logger;
        _context = context;
    }
    ...
    public async Task<IActionResult> Index()
    {
        ...
        IndexModel model = new()
        {
            ...
            Projects = await issues.Where(i => i.isProject == true).ToListAsync(),
        ...
        model.Projects = await issues.Where(i => i.Assignee.Id == model.LoggedUser.Id && i.isProject).ToListAsync();
        return View(model);
    }
    ...
    public async Task<IActionResult> Create([Bind("IssueNameDto", "IssueParentIdDto", "IssueStatusNameDto", "IssueStartDateDto", "IssueEndDateDto", "IssueAssigneeNameDto", "IssueDescriptionDto")] IndexModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            issue = new Issue(model.IssueNameDto, startDate, endDate, duration, model.IssueDescriptionDto, status, null, assignee);
