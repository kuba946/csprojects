...
namespace BazaPojazdow.Controls
{
    public partial class Status : UserControl
    {
        ...
        private string[] statusMessages = { "Niedostępny!", "W serwisie...", "Dostępny" };
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Statuses statuses = new Statuses(new Brush[] { Brushes.Red, Brushes.Orange, Brushes.Green }, new string[] { "Zarezerwowany!", "W serwisie...", "Dostępny :)" });
            for (int i = 0; i < 3; i++)
            {
                if (actualStatus == i)
                {
